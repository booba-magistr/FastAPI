// Сбор данных с формы и выполнение при их помощи POST запроса
async function regFunction(event) {
    ...
    // Выполнятся асинхронный POST запрос
    // '/users/register' - ссылка на endpoint в /users/router
    try {
        const response = await fetch('/users/register', {
            ...
            body: JSON.stringify(data)  // объект данных трансформируется в JSON
        });
